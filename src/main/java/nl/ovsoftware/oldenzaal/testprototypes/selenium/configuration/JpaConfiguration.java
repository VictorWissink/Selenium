package nl.ovsoftware.oldenzaal.testprototypes.selenium.configuration;
...
@Configuration
@EnableJpaRepositories(basePackages = "nl.ovsoftware.oldenzaal.testprototypes.selenium.repositories",
...
public class JpaConfiguration {
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "nl.ovsoftware.oldenzaal.testprototypes.selenium.model" });
